...
const mockTransactionDetail: TransactionDetail = {
    ...
    description:
        "This is the transaction description, sometimes it explains the reasoning and notes to the receiver",
    amount: 20.0,
    currency: "USDT",
    disputer: {
        username: "Username",
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <Text className="text-primary-text text-base">
                                        {mockTransactionDetail.from.username} (
                                        {mockTransactionDetail.from.principal})
                                    </Text>
                                    <ActionIcon
                                        variant="subtle"
                                        color="blue"
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <Text className="text-primary-text text-base">
                                        {mockTransactionDetail.to.username} (
                                        {mockTransactionDetail.to.principal})
                                    </Text>
                                    <ActionIcon
                                        variant="subtle"
                                        color="blue"
                        ...
                        <div>
                            ...
                            <Text className="text-incoming-text text-lg font-semibold">
                                {mockTransactionDetail.currency} +
                                {mockTransactionDetail.amount.toFixed(2)}
                            </Text>
                        </div>
