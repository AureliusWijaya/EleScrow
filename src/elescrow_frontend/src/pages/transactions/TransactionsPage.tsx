...
function TransactionsPage(): JSX.Element {
    ...
    const handleConfirmAction = () => {
        notifications.show({
            ...
            message: `Transaction ${selectedTransactionId} has been ${
                selectedAction === "approve" ? "approved" : "rejected"
            }`,
    ...
    const incomingCount = mockTransactions.filter(
        (t) => t.type === "incoming"
    ).length;
    const outgoingCount = mockTransactions.filter(
        (t) => t.type === "outgoing"
    ).length;
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-gray-800/30 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <TextInput
                            ...
                            rightSection={
                                <i className="bi bi-search text-secondary-text"></i>
                            }
                            className="w-80"
                            classNames={{
                    ...
                    >
                        <Table.Thead>
                            <Table.Tr>
                                <Table.Th className="text-primary-text">
                                    Transaction ID
                                </Table.Th>
                                <Table.Th
                        ...
                        <Table.Tbody className="bg-slate-700">
                            {rows}
                        </Table.Tbody>
                    </Table>
                ...
                >
                    <div className="text-center p-6">
                        <Text
                            size="xl"
                            className="text-primary-text mb-6 font-semibold"
                        >
