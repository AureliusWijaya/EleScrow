...
import { useActor } from "../../shared/store/actor-store";
...
function HomePage(): JSX.Element {
    ...
    useEffect(() => {
        if (actor != null && principal != null && isAuthenticated) {
            actor
                .get_conversation_chunk(Principal.fromText(principal), {
                    offset: BigInt(0),
                    limit: BigInt(100),
                })
                .then((result) => console.log(result));

            actor.get_current_user().then((result) => console.log(result));
        }
    }, [actor, principal, isAuthenticated]);

    const onAuthButtonClicked = async () => {
        await loginToICP();
    };

    return (
        <div className="w-full">
            <div className="flex flex-col min-h-page items-center justify-center relative">
                <div className="flex flex-col gap-10 items-center justify-center px-20 py-32 relative">
                    ...
                    <div className="flex flex-col text-center text-lg text-secondary-text z-10">
                        <span className="w-full">
                            EleScrow is a decentralized escrow platform that
                            safeguards your transactions.
                        </span>
                        <span className="w-full">
                            Send with confidence. Funds are only released when
                            both parties agree.
                        </span>
                    </div>

                    <Button
                        className="!px-16 !py-4 z-10"
            ...
            <div className="flex flex-col min-h-screen mt-20">
                <div className="flex lg:flex-row flex-col h-1/2 lg:justify-center lg:gap-52 gap-20 items-center">
                    <div className="flex flex-col gap-4 items-center">
                        <span className="w-full text-5xl font-medium">
                            How It Works
                        </span>
                    ...
                    <Stepper
                        ...
                        classNames={{
                            stepLabel: "mt-3",
                            stepIcon:
                                "!bg-secondary !border-none !text-primary-text",
            ...
            <div className="flex flex-col min-h-screen gap-10 items-center relative">
                ...
                <div className="flex w-full justify-center flex-wrap gap-10">
                    ...
                    <div className="flex flex-col bg-[#1A1B23] p-6 items-center justify-center rounded-xl gap-4 w-96 h-72 text-center">
                        ...
                        <span className="text-secondary-text">
                            A safety net: transactions only proceed with admin
                            confirmation.
                        </span>
                    </div>
                </div>
